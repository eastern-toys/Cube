...
public class HuntceptionUnlockEventProcessor extends AbstractUnlockEventProcessor {

    public HuntceptionUnlockEventProcessor(HuntStatusStore huntStatusStore) {
    ...
    protected AbstractUnlockUpdateCalculator generateUnlockUpdateCalculator(
        ...
        return new HuntceptionUnlockUpdateCalculator(
